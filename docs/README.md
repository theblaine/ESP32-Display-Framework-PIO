...
3. [Library Reference](LIBRARY_REFERENCE.md)
...
- [`../src/demos/display_widgets/README.md`](../src/demos/display_widgets/README.md)
- [`../src/demos/sd_usb/README.md`](../src/demos/sd_usb/README.md)
- [`../CHANGELOG.md`](../CHANGELOG.md)
- [`../BASELINE.md`](../BASELINE.md)

The public headers under `lib/` remain the authoritative API definitions.
